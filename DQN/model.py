...
class DeepQNetwork(object):
    def __init__(self, n_actions,n_features,lr=0.01,reward_decay = 0.9, e_greedy = 0.9, replace_target_iter=300,
    ...
    def _build_net(self):
        ...
        with tf.variable_scope('eval_net'):
            e1 = tf.layers.dense(self.s, 20,tf.nn.relu,kernel_initializer=w_initializer,
                                        bias_constraint=b_initializer, name='e1')
        ...
        with tf.variable_scope('q_eval'):   #choose eval steps
